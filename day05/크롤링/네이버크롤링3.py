...
name_list = ['삼성전자', '카카오', 'LG전자']
code_list = ['005930', '035720', '066570']
for index in range(len(code_list)):
    con = request.urlopen('https://finance.naver.com/item/main.nhn?code='+code_list[index]) #연결부품획득 : 변수에 넣어줘야
    # print('1. 연결 성공', con)
    #name='삼성전자' # txt 파일로 저장하자  <- 삼성전자 주가. 향후 같은 ui에서 다른 코드 가져올 것: for문 사용
